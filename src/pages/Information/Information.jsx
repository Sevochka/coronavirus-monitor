  ...
  <Collapse accordion>
    <Panel header="Профилактика" key="1">
      <p>
        ...
        принимайте необходимые меры профилактики. Следуйте рекомендациям местных органов
        здравоохранения.
      </p>
      ...
      <p>
        Чем раньше вы обратитесь за помощью, тем быстрее вас направят к нужному врачу. Так вы
        защитите себя и предотвратите распространение вирусов и других инфекций.
      </p>
      <p>
        ...
        соблюдать безопасную дистанцию и правила гигиены рук. Следуйте рекомендациям местных
    ...
    <Panel header="Симптомы" key="2">
      <p>
        ...
        У большинства инфицированных болезнь протекает в легкой или средней форме тяжести, и им не
    ...
    <Panel header="Лечение" key="4">
      <Collapse accordion>
        <Panel header="Самостоятельное лечение" key="1">
          ...
          <p>
            Находясь дома, придерживайтесь здорового ‎образа жизни. Рекомендуется правильно
            ‎питаться, соблюдать правильный режим сна, ‎ сохранять двигательную активность и
            ‎использовать телефон или сеть Интернет для ‎общения с друзьями и близкими. В трудные
            ‎периоды дети нуждаются в особой любви и ‎внимании со стороны взрослых. Старайтесь ‎по
            возможности придерживаться одного и ‎того же распорядка дня. ‎
          </p>
          <p>
            В условиях кризиса грусть, стресс, ‎растерянность – нормальные эмоции. ‎Помочь в такой
            ситуации может ‎доверительное общение с близкими и ‎друзьями. Если вы чувствуете, что
            не ‎справляетесь с ситуацией, обратитесь за ‎помощью к медицинскому или социальному
            ‎работнику. ‎
          </p>
        </Panel>
