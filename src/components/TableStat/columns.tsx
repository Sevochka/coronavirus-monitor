...
const columns = [
    ...
    },
    {
        ...
        width: '14%',
        sorter: {
            compare: (a: ICountryMainStat, b: ICountryMainStat): number => +a.totalNewCasesToday - +b.totalNewCasesToday,
            multiple: 1,
        },
    ...
    },
    {
        ...
        width: '14%',
        sorter: {
            compare: (a: ICountryMainStat, b: ICountryMainStat): number => +a.totalDeaths - +b.totalDeaths,
            multiple: 2,
        },
    ...
    },
    {
        ...
        width: '14%',
        sorter: {
            compare: (a: ICountryMainStat, b: ICountryMainStat): number => +a.totalNewDeathsToday - +b.totalNewDeathsToday,
            multiple: 1,
        },
    ...
    },
    {
        ...
        width: '14%',
        sorter: {
            compare: (a: ICountryMainStat, b: ICountryMainStat): number => +a.totalRecovered - +b.totalRecovered,
            multiple: 2,
        },
    ...
    },
    {
        ...
        width: '14%',
        sorter: {
            compare: (a: ICountryMainStat, b: ICountryMainStat): number => +a.totalSeriousCases - +b.totalSeriousCases,
            multiple: 1,
        },
